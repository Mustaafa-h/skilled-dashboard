    ...
    <div className={styles.container}>
      ...
      <div className={styles.top}>
        ...
        />
          ...
          <button onClick={()=>router.push(`/dashboard-superadmin/companies/${companyId}/workers/add`)} className={styles.addButton} >
            ...
            <div className={styles.workerCard} key={worker._id}>
              ...
              <div className={styles.cardButtons}>
                  <button 
                    ...
                    onClick={()=>router.push(`/dashboard-superadmin/companies/${companyId}/workers/edit/${worker._id}`)}
